...
{
    $entity = $provider->database->item("SELECT * FROM " . consts::$table_module_html . " WHERE `menu_modules_id` = '".$provider->variables->content_id . "' ORDER BY `id` LIMIT 1");
...
{
    $provider->database->query("INSERT INTO " . consts::$table_module_html . "(`menu_modules_id`, `title`, `description`) VALUES
            (
...
{
    $provider->database->query("UPDATE " . consts::$table_module_html . " SET
